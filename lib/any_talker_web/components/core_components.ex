defmodule AnyTalkerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnyTalkerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnyTalkerWeb.Gettext, "errors", msg, opts)
    end
  end
