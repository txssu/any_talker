defmodule JokerCynicWeb.Endpoint do
  ...
  plug Plug.Static,
    ...
    from: :joker_cynic,
    gzip: false,
    only: JokerCynicWeb.static_paths()
  ...
  plug Unplug,
    if: JokerCynicWeb.SecureMetricsEndpointPredicate,
    do: {PromEx.Plug, prom_ex_module: JokerCynic.PromEx}
